  ...
  return (
    <section className="my-1 grid w-full gap-2">
      <div className="grid-cols grid w-full grid-cols-12 justify-between lg:gap-x-3">
        ...
        <span className="col-span-4 text-xs italic text-mediumGray lg:col-span-4 lg:text-[12px]">
          {experience.title}
        </span>
        <span className="col-span-6 text-xs text-lightGray lg:col-span-4 lg:text-[12px]">
          {experience.organization}
        </span>
        <span className="col-span-0 hidden text-xs text-mediumGray lg:col-span-2 lg:block lg:text-[12px]">
          {experience.location}
        </span>
        <span className="col-span-2 text-right text-xs text-lightGray lg:text-[12px]">
      ...
      <div className="ml-5 hidden w-full flex-col gap-1 text-sm font-light text-lightGray lg:flex">
        {experience.bulletPoint1 && (
          <span className="text-xs text-mediumGray lg:text-[12px]">
            · {experience.bulletPoint1}
          </span>
        )}
