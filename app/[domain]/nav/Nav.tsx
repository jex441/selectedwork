    ...
    <>
      ...
      >
        <div className="fixed z-20 flex lg:static lg:flex-row lg:items-center">
          ...
          <nav
            className={`${open ? 'flex' : 'hidden'} fixed top-10 z-10 h-full w-full flex-col gap-4 bg-white px-5 pl-10 pt-20 text-[32px] lg:static lg:top-auto lg:mx-5 lg:flex lg:w-auto lg:flex-row lg:items-center lg:gap-4 lg:p-0 lg:text-sm`}
          >
