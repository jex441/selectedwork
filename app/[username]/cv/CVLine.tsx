  ...
  return (
    <section className="my-2 w-full">
      <div className="grid-cols grid w-full grid-cols-12 justify-between lg:gap-3">
        ...
        <span className="col-span-4 text-xs lg:col-span-3 lg:truncate lg:text-sm">
          {experience.organization}
        </span>
        <span className="col-span-0 hidden truncate text-xs lg:col-span-2 lg:block lg:text-sm">
          {experience.location}
        </span>
        <span className="col-span-3 truncate text-right text-right text-xs lg:text-sm">
